...
import extension.GZPlaceExtension
 ...
 * com/android/plugin_model1/LastLogger.class:/Users/holy/Desktop/PluginDemo/app/src/main/java/com/android/plugindemo/LastLogger.class
 */
class GZClassPlacePlugin extends Transform implements Plugin<Project> {

    private static final String PLUGIN_NAME = "GZClassReplacePlugin"
    ...
    void apply(Project project) {
        ...
        project.extensions.create("GZPlace", GZPlaceExtension, project)
    ...
    void transform(Context context, Collection<TransformInput> inputs, Collection<TransformInput> referencedInputs, TransformOutputProvider outputProvider, boolean isIncremental) throws IOException, TransformException, InterruptedException {
        ...
        GZPlaceExtension placeExtension = project.extensions.findByType(GZPlaceExtension)
