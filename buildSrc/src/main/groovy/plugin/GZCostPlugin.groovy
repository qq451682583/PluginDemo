...
class GZCostPlugin extends Transform implements Plugin<Project> {

    private static final String PLUGIN_NAME = "GZCost"
    ...
    @Override
    String getName() {
        return PLUGIN_NAME// transformClassesWithGZCostForDebug
    }
    ...
    void transform(Context context, Collection<TransformInput> inputs, Collection<TransformInput> referencedInputs, TransformOutputProvider outputProvider, boolean isIncremental) throws IOException, TransformException, InterruptedException {
        ...
        project.logger.error "========== GZCostPlugin transform start ==========="
        ...
        project.logger.error "========== GZCostPlugin transform const time (${System.currentTimeMillis() - startTime} ms) ==========="
        project.logger.error "========== GZCostPlugin transform end ==========="
    }
}